"""
Entraînement EfficientNet-B0 pour détection de deepfakes
...
SAVE_PATH = SAVE_DIR / "efficientnet_b0_best.pth"
...
def main():
    ...
    with mlflow.start_run(run_name=MODEL_NAME):
        ...
        mlflow.log_params({
            ...
            "unfrozen_blocks": "features[7], features[8], classifier",
            "device": str(DEVICE)
        })
